...
def main():
    ...
    INPUT_FILE = '/scratch/asevivek/vivek_cases/000_datasets/000/_toolbox_outputs/information_theory/permutation_related/permutation_transfer_entropy_computations/single_cylinder_Re7k_with_PGS_with_inflow_turb/pTE_om_z_2d_to_v_2d_dsmpl_3x.h5'
    OUTPUT_FILE = None  # If None, will create output file next to input with '_max_values_and_delays' suffix
